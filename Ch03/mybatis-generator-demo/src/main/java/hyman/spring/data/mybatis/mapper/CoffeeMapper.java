...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Sat Mar 23 22:49:22 CST 2019
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=hyman.spring.data.mybatis.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("hyman.spring.data.mybatis.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=hyman.spring.data.mybatis.handler.MoneyTypeHandler},",
